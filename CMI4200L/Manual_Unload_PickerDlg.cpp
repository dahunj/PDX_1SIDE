// Manual_Unload_PickerDlg.cpp : 구현 파일입니다.
//
...
// CManual_Unload_PickerDlg 대화 상자입니다.

IMPLEMENT_DYNAMIC(CManual_Unload_PickerDlg, CDialogEx)

CManual_Unload_PickerDlg::CManual_Unload_PickerDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(CManual_Unload_PickerDlg::IDD, pParent)
{

}

CManual_Unload_PickerDlg::~CManual_Unload_PickerDlg()
{
}

void CManual_Unload_PickerDlg::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CManual_Unload_PickerDlg, CDialogEx)
	ON_WM_DESTROY()
	ON_WM_SHOWWINDOW()
	...
	ON_BN_CLICKED(IDC_BTN_NG_PICKER_MOVE, &CManual_Unload_PickerDlg::OnBtnNGPickMoveClick)
	ON_BN_CLICKED(IDC_BTN_NG_PICKER_MOVE2, &CManual_Unload_PickerDlg::OnBnClickedBtnNgPickerMove2)
END_MESSAGE_MAP()


// CManual_Unload_PickerDlg 메시지 처리기입니다.

BOOL CManual_Unload_PickerDlg::OnInitDialog() 
{
...
void CManual_Unload_PickerDlg::OnDestroy() 
{
	CDialogEx::OnDestroy();
}

BOOL CManual_Unload_PickerDlg::PreTranslateMessage(MSG* pMsg) 
{
...
void CManual_Unload_PickerDlg::OnShowWindow(BOOL bShow, UINT nStatus) 
{
	CDialogEx::OnShowWindow(bShow, nStatus);
}

void CManual_Unload_PickerDlg::Initial_Controls() 
{
...
void CManual_Unload_PickerDlg::Display_Status()
{
...
void CManual_Unload_PickerDlg::OnBtnMLNGPickY1Click(UINT nID)
{
	CAJinAXL *pAJinAXL = CAJinAXL::Get_Instance();
...
void CManual_Unload_PickerDlg::OnBtnMLNGPickY2Click(UINT nID)
{
	CAJinAXL *pAJinAXL = CAJinAXL::Get_Instance();
	CCommon *pCommon = CCommon::Get_Instance();
...
void CManual_Unload_PickerDlg::OnBtnMLNGPickZClick(UINT nID)
{
	CAJinAXL *pAJinAXL = CAJinAXL::Get_Instance();
	DX_DATA_2 *pDX2 = pAJinAXL->Get_pDX2();
	DX_DATA_5 *pDX5 = pAJinAXL->Get_pDX5();
...
void CManual_Unload_PickerDlg::OnBtnMLPickIOClick(UINT nID)
{
	CAJinAXL *pAJinAXL = CAJinAXL::Get_Instance();
...
void CManual_Unload_PickerDlg::OnBtnNGPickMoveClick()
{
/*
	CString sTmp[4];
	int xx, yy, zz;
...
void CManual_Unload_PickerDlg::OnBtnNGPickMovePosClick(UINT nID)
{
...
void CManual_Unload_PickerDlg::OnBnClickedBtnNgPickerMove2()
{
	CString sTmp[4];
	int xx, yy, zz;
